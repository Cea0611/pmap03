const API_URL_UPDATE_LOCATION = "https://172.18.70.167:5176/api/users/updateUserLocation";
var reqcount = 0;
...
function successCallback(position) {
    const { accuracy, latitude, longitude, altitude, heading, speed, uuid } = position.coords;
